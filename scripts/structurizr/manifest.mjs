...
export const L3_COMPONENTS = {
  agentServer: [
    ...
    { id: 'outerBrainFacade', name: 'Outer Brain Facade', path: 'packages/server/src/outer/outer-brain.ts; packages/server/src/outer/outer-http-inbound.ts' },
    ...
    { id: 'structuredReplyParts', name: 'Structured Reply Parts', path: 'packages/server/src/outer/structured-reply-parts.ts' },
    ...
    { id: 'kpiAdvancer', name: 'KPI Advancer', path: 'packages/server/src/outer/kpi/kpi-advancer.ts' },
    { id: 'kpiManager', name: 'KPI Manager', path: 'packages/server/src/outer/kpi/kpi-manager.ts' },
    { id: 'environmentSensorRegistry', name: 'Environment Sensor Registry', path: 'packages/server/src/outer/environment/sensor-registry.ts' },
    { id: 'environmentModelFacade', name: 'Environment Model Facade', path: 'packages/server/src/outer/environment/index.ts' },
    { id: 'kpiSpawnCapacity', name: 'KPI Spawn Capacity', path: 'packages/server/src/outer/environment/kpi-spawn-capacity.ts' },
    { id: 'innerBurstExit', name: 'Inner Burst Exit', path: 'packages/server/src/outer/inner-burst-exit.ts' },
    ...
    { id: 'llmUsageJournal', name: 'LLM Usage Journal', path: 'packages/server/src/outer/llm-usage-journal.ts' },
    ...
    { id: 'casualChatDispatcher', name: 'Casual Chat Dispatcher', path: 'packages/server/src/outer/casual-chat-dispatcher.ts' },
...
export const L3_RELATIONSHIPS = [
  ...
  ['agentServer', 'casualChatDispatcher', 'outerToolExecutor', 'import'],
  ['agentServer', 'casualChatDispatcher', 'agentPersonality', 'import'],
  ['agentServer', 'casualChatDispatcher', 'kpiRegistry', 'import'],
  ['agentServer', 'outerHeartbeat', 'environmentModelFacade', 'import'],
  ['agentServer', 'outerHeartbeat', 'kpiManager', 'import'],
  ['agentServer', 'environmentModelFacade', 'environmentSensorRegistry', 'import'],
  ['agentServer', 'kpiManager', 'kpiSpawnCapacity', 'import'],
  ['agentServer', 'kpiAdvancer', 'kpiSpawnCapacity', 'import'],
  ['agentServer', 'kpiSpawnCapacity', 'autonomyPolicyStore', 'import'],
  ['agentServer', 'kpiManager', 'autonomyPolicyStore', 'import'],
  ['agentServer', 'kpiManager', 'kpiAdvancer', 'import'],
